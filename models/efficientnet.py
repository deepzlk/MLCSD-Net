...
class EfficientNet(nn.Module):
    ...
    def __init__(self, subtype='efficientnet_b0', num_classes=100):
        ...
        self.stage4 = self.make_layer(self._calculate_width(24), self._calculate_width(40), kernel_size=3, stride=1, block=self._calculate_depth(2))
        ...
        self.stage6 = self.make_layer(self._calculate_width(80), self._calculate_width(112), kernel_size=3, stride=1, block=self._calculate_depth(3))
        self.stage7 = self.make_layer(self._calculate_width(112), self._calculate_width(192), kernel_size=3, stride=2, block=self._calculate_depth(4))
