...
class ResNet(nn.Module):
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        f0 = out
        out,out1, f1_pre = self.layer1(out)
        f1 = out1
        f2 = out
        out,out2, f2_pre = self.layer2(out)
        f3 = out2
        f4 = out
        out,out3, f3_pre = self.layer3(out)
        f5 = out3
        f6 = out
        out,out4, f4_pre = self.layer4(out)
        f7 = out4
        f8 = out
        ...
        if is_feat:
            if preact:
                ...
                return [ f1, f2, f3, f4, f5, f6, f7,f8], out
        else:
            return out
