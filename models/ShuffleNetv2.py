...
class ShuffleNetV2(GeneralNet):
    def __init__(self, net_size, num_classes=100):
        ...
        self.in_channels = 24
        self.layer1 = self._make_layer(out_channels[0], num_blocks[0],1)
        self.layer2 = self._make_layer(out_channels[1], num_blocks[1],2)
        self.layer3 = self._make_layer(out_channels[2], num_blocks[2],2)
        self.layer4 = self._make_layer(out_channels[3], num_blocks[3],2)

        self.linear = nn.Linear(out_channels[3], num_classes)

    def _make_layer(self, out_channels, num_blocks,stride):
        layers = [DownBlock(self.in_channels, out_channels,stride)]
