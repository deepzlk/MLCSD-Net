...
from helper.loops import train_mlcsd as train, validate_mlcsd as validate
...
def parse_option():
    ...
    if hostname.startswith('visiongpu'):
        ...
        opt.model_path = './save/models/mlcsd'
    ...
    if not os.path.exists(os.path.join(opt.teachertest_path, 'mlcsd_test.csv')):
        with open(os.path.join(opt.teachertest_path, 'mlcsd_test.csv'), 'w') as f:
...
def main():
    ...
    trainable_list.append(embedding)
    ...
    with open(os.path.join(opt.teachertest_path, 'mlcsd_test.csv'), 'a') as f:
